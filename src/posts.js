export default [
  {
    ...
    prices: [
      {
        operation_type: 1,
        price: { amount: 13500, currency: 'ARS' },
        expenses: { amount: 3500, currency: 'ARS' },
      },
    ],
    operation_type: { operation_type_id: 1, operation_type_name: 'Alquiler' },
    plan: 'SIMPLE',
    publish_date: '23/01/2020',
    status: { status: 'AVAILABLE', label: 'Disponible' },
    title: 'Guido y Callao, 2amb coc y lav todo luz 50m impec amob categoría ',
    picture:
      'https://preprostatic.zonapropcdn.com/avisos/1/00/44/55/79/81/360x266/1693121343.jpg',
    slug: 'guido-y-callao-2amb-coc-y-lav-todo-luz-50m-impec-44557981',
    description:
  ...
  },
  {
    ...
    slug: 'dueno-san-lorenzo-guemes.-lc-2-d-a-balcon-terraz-44554144',
    description:
  ...
  },
  {
    ...
    status: { status: 'RESERVED', label: 'Reservado' },
    ...
    slug: 'juncal-coronel-diaz.-al-frente-63m-gran-balcon-t-44186948',
    description:
